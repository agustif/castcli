// HAP pair-setup accessory: responds to controller M1/M3/M5 with M2/M4/M6.
//
// This is the accessory (receiver) side of the pair-setup protocol. The controller
// sends M1/M3/M5, we respond with M2/M4/M6 using real SRP-6a and Ed25519 signatures.

import { Crypto, Effect, Option, Redacted, Ref, Schema } from "effect"
import type { PlatformError } from "effect/PlatformError"
import { PairingError, PairingMethod, SrpUsername, TlvType } from "../Generated/index.ts"
import { byte, type Item } from "../Tlv8/index.ts"
import { type ForgedFrame, Nonce, Suite } from "../Suite/index.ts"
import { Errors as SrpErrors, Group, Server, Verifier } from "../Srp/index.ts"
import * as Attempts from "./Accessory/Attempts.ts"
import { MalformedMessage, UnexpectedState } from "./Accessory/Errors.ts"
import { fromSeed, type Identity } from "./Accessory/Identity.ts"
import { ADMIN, MAX_IDENTIFIER_BYTES, type Pairing } from "./Accessory/Pairing.ts"
import * as Request from "./Accessory/Request.ts"
import { State } from "./Accessory/State.ts"
import * as Tlv8 from "../Tlv8/index.ts"

const encode = Schema.encodeEffect(Tlv8.Items)
const decode = Schema.decodeUnknownEffect(Tlv8.Items)
const item = (type: number, value: Uint8Array): Item => ({ type, value })
