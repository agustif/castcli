...
import { CastMessageFields, PayloadType, ProtocolVersion } from "../src/Cast/Protocol/Generated.ts"
import { decodeMessage, encodeFrame, Payload, takeFrames } from "../src/Cast/Protocol/Frame.ts"

const PROTO = path.resolve(import.meta.dirname, "../docs/reference/cast_channel.proto")
